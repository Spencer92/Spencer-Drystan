...
int main() {
	...
	fbAltscreen2 = (char*)Malloc(BUFFER_SIZE);

	fbAltscreen = (char*) (((UINT32) fbAltscreen + 256)
			               & (UINT32) 0x00FFFF00); /* The screens have to be 256 byte alligned */

    fbAltscreen2 = (char*) (((UINT32) fbAltscreen + 256)
			               & (UINT32) 0x00FFFF00);
	clear(fbAltscreen); 
	
	makeGameScreens(fbAltscreen ,fbAltscreen2);
	...
	do {
		...
		/*	plotLargeSprite(fbAltscreen, arrayPtr, 250, 400, 32);
			...
			plotLargeSprite(fbAltscreen, arrayPtr, -5, 200, 32);
			
			plotLargeSprite(fbAltscreen,arrayPtr , 600, 10, 32);
		...
		case 'e': /* Animation demo */
			...
			plotString(fbAltscreen, str, 7, 30, 30);
...
void printMenu() {
	 ...
	 Cconws("Select e for a string test demo\r\n\0");
